...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            // ✅ Call stored procedure for booking
            String aadhar = tfaadhar.getText();
            ...
            try {
                ...
                CallableStatement cs = conn.c.prepareCall("{call book_flight(?, ?, ?, ?, ?, ?, ?, ?)}");
                cs.setString(1, aadhar);
                cs.setString(2, name);
                cs.setString(3, nationality);
                cs.setString(4, flightname);
                cs.setString(5, flightcode);
                cs.setString(6, src);
                cs.setString(7, des);
                cs.setString(8, ddate);
